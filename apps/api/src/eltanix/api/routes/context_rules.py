"""Rota das regras de contexto por glob (`.eltanix/context_rules.yaml`) —
...
from eltanix.agent import context_rules_editor as editor
from eltanix.agent.context_rules import ContextRule, ContextRulesConfig
