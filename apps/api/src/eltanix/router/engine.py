...
from eltanix.optimizer.complexity import classify as classify_complexity
from eltanix.optimizer.compressor import ContextCompressor
...
from eltanix.router.adapters import ProviderAdapter, build_adapters
from eltanix.router.budget import BudgetGuard
from eltanix.router.catalog import Catalog, ModelSpec
...
from eltanix.router.telemetry import TelemetryEntry
from eltanix.router.telemetry import record as _record_telemetry
...
class RouterEngine:
    ...
    def build(self) -> None:
        ...
        from eltanix.telemetry.langfuse_tracer import is_langfuse_configured
