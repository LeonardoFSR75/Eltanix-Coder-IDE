...
from eltanix.analytics.models.classifier import FailureCategory
    ...
    async def generate_proposal(
        ...
        if category == FailureCategory.TOOL_EXECUTION_FAILURE:
            return {
                ...
                "target_file": "apps/api/src/eltanix/agent/tools/sandbox.py",
            ...
            return {
                ...
                "target_file": "apps/api/src/eltanix/context/store.py",
        ...
        return {
            ...
            "target_file": "apps/api/src/eltanix/agent/runner.py",
