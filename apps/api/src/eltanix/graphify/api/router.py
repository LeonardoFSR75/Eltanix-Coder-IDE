...
from eltanix.api.deps import AuthDep, DbSessionDep, SettingsDep
from eltanix.graphify.engine import GraphifyEngine
from eltanix.graphify.metrics.analytics import GraphAnalytics
...
from eltanix.workspace.projects import ProjectError, ensure_project_slug_exists
...
def _derive_workspace(payload: dict[str, Any]) -> str:
    ...
    project_name = payload.get("project") or "Eltanix Coder IDE"
