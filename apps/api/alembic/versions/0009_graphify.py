...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("relevance_score", sa.Numeric(precision=5, scale=4), server_default="1.0000"),
    ...
    op.create_table(
        ...
        sa.Column("community_id", sa.Integer(), server_default="0"),
    ...
    op.execute(
        ...
        "GENERATED ALWAYS AS (in_degree = 0 AND out_degree = 0) STORED"
    )
