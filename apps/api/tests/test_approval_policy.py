...
from eltanix.agent.approval_policy import (
    ApprovalPolicy,
    EditPathRule,
    ExecCommandRule,
    evaluate_policy,
...
def test_exec_command_rule_prefix_does_not_match_partial_token():
    ...
    from eltanix.agent.approval_policy import _matches_exec_command_rule
...
def test_evaluate_policy_swallows_exception_from_a_single_rule(ctx, monkeypatch):
    ...
    import eltanix.agent.approval_policy as approval_policy_module
