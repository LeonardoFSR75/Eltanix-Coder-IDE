...
docker compose exec postgres psql -U eltanix -d eltanix -c "CREATE DATABASE eltanix_test"
DATABASE_URL="postgresql+asyncpg://eltanix:eltanix@localhost:5403/eltanix_test" uv run alembic upgrade head

# a cada vez que quiser rodar os testes de RRF:
DATABASE_URL_TEST="postgresql+asyncpg://eltanix:eltanix@localhost:5403/eltanix_test" \
