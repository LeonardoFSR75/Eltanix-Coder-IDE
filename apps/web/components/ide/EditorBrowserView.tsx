...
interface EditorBrowserViewProps {
   ...
   * sandbox, resolvida por `eltanix-<sessionId>:<porta>` dentro do
...
const DOCKER_INTERNAL_HOSTNAME_RE =
  /^(eltanix-[\w-]+|web|api|executor|redis|minio|postgres|browser|ollama|mcp-scanner|host\.docker\.internal)$/i;
