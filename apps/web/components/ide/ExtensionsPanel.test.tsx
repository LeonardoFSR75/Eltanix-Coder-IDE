...
describe("ExtensionsPanel", () => {
  ...
  it("recarrega quando o evento eltanix:extensions:changed é disparado (ex.: ferramenta do agente)", async () => {
    mockedApi.getExtensionsCatalog.mockResolvedValue(catalog());
    render(<ExtensionsPanel />);
    await screen.findByText("Ruff");
    ...
    window.dispatchEvent(new CustomEvent("eltanix:extensions:changed"));
