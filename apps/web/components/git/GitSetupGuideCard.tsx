    ...
    <div className="panel-box" style={{ background: "var(--surface)", borderColor: "var(--border)" }}>
      ...
      <div className="mt-4 text-xs" style={{ color: "var(--text)" }}>
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              <h4 className="m-0 text-sm font-semibold mb-1" style={{ color: "var(--text)" }}>
                Por que configurar o Git e o GitHub no SicoobitoCode?
              </h4>
              <p className="m-0 text-muted leading-relaxed">
                O SicoobitoCode integra o desenvolvimento local com a inteligência do Agente de IA. Para que o
          ...
          <div className="flex flex-col gap-3">
            ...
            <ol className="m-0 pl-4 flex flex-col gap-2 text-muted">
              <li>
                ...
                <a
                  href="https://github.com/settings/tokens/new?scopes=repo,read:user,user:email,workflow&description=SicoobitoCode+IDE"
                  target="_blank"
        ...
        {activeTab === "agent" && (
          <div className="flex flex-col gap-3">
            <p className="m-0 text-muted leading-relaxed">
              Após configurar sua identidade e o token do GitHub, o Agente de IA e a IDE do SicoobitoCode ganham superpoderes:
            </p>
